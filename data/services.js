export const serviceCategories = [
  {
    ...
    services: [
      ...
      {
        name: "PhiContour Dudak Renklendirme",
        description: "Dudak tonunu canlandıran, yumuşak geçişli ve kişiye özel renk planlaması."
      },
      {
        name: "PhiLiner Kalıcı Eyeliner",
        description: "Bakışlara netlik katan, ince ve zarif kalıcı eyeliner uygulaması."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    services: [
      ...
      {
        name: "Profesyonel Cilt Bakım Protokolleri",
  ...
  },
  {
    ...
    services: [
      {
        name: "Protez Tırnak",
        description: "Doğal tırnak yapısına uygun, estetik ve uzun ömürlü tırnak görünümü."
      },
      {
        name: "Jel Tırnak",
        description: "Parlak, güçlü ve bakımlı görünüm sunan jel tırnak uygulaması."
      },
      {
        name: "Nail Art",
        description: "Minimal, modern veya özel tasarım detaylarla kişisel tırnak sanatı."
      }
    ]
  },
  {
    id: "cok-yakinda",
    title: "Çok Yakında",
    summary: "AŞK Beauty deneyimini tamamlayacak yeni bakım ve terapi uygulamaları.",
